                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('student.add') }}" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('roll_no') is-invalid @enderror" placeholder="10706" name="roll_no" value="{{ old('roll_no') }}" />
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('username') is-invalid @enderror" placeholder="{{ config('student.default_username') }}" name="username" value="{{ old('username') ?? config('student.default_username') }}" />
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div>
                                        <input type="password" class="form-control @error('password') is-invalid @enderror" value="{{ config('student.default_password') }}" name="password" />
